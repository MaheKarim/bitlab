...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function(){
        ...
        // Wallet & Transaction
        Route::get('total/wallet', 'totalWallet')->name('total.wallet');
        Route::get('receive/history', 'receiveHistory')->name('receive.history');
        Route::get('send/history', 'sendHistory')->name('send.history');
        Route::get('pending/send/history', 'sendPendingHistory')->name('send.pending.history');
        Route::get('failed/send/history', 'sendInFailedHistory')->name('send.failed.history');
    });
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function(){
        ...
        Route::get('user/send/history/{id}', 'sendHistory')->name('send.history');
        Route::get('user/receive/history/{id}', 'receiveHistory')->name('receive.history');
        Route::get('user/wallet/{id}', 'userWallet')->name('wallet');
    ...
    Route::controller('ApiController')->name('api.')->prefix('api')->group(function (){
        Route::get('api-setting', 'index')->name('setting');
        Route::post('api-update', 'apiUpdate')->name('update');
    });
});
